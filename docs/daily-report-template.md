...
- Manager/Product no-issue triage: created/proposed #... | not run because open issue #... selected | blocked because ... | none warranted only because no public-safe, non-invented issue could be written after reviewing ..., considering candidate ..., and rejecting it because ...
