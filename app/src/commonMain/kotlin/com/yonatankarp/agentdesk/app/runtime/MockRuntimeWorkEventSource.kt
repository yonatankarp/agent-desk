    ...
    companion object {
        val observations =
            listOf(
                ...
                RuntimeWorkObservation(
                    eventId = "event:agent-task:44:started",
                    occurredAt = "2026-06-02T21:05:00Z",
                    source = "mock-adapter",
                    workItemId = "agent-task:44",
                    kind = RuntimeWorkObservationKind.Started,
                    title = "Investigate core test failure",
                    summary = "Agent started checking the failing test output.",
                ),
                RuntimeWorkObservation(
                    eventId = "event:agent-task:44:blocked",
                    occurredAt = "2026-06-02T21:06:00Z",
                    source = "mock-adapter",
                    workItemId = "agent-task:44",
                ...
                RuntimeWorkObservation(
                    eventId = "event:agent-task:45:started",
                    occurredAt = "2026-06-02T21:10:00Z",
                    source = "mock-adapter",
                    workItemId = "agent-task:45",
                    kind = RuntimeWorkObservationKind.Started,
                    title = "Choose retry strategy",
                    summary = "Agent collected retry options for operator review.",
                ),
                RuntimeWorkObservation(
                    eventId = "event:agent-task:45:needs-decision",
                    occurredAt = "2026-06-02T21:11:00Z",
                    source = "mock-adapter",
                    workItemId = "agent-task:45",
